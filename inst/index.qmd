...
intro <- tryCatch(
    {
        description <- packageDescription("OXA")
...
👉 [ghcr.io/dummy/oxa](https://ghcr.io/dummy/oxa) 🐳
...
#| eval: false
docker run -it ghcr.io/dummy/oxa:devel R
```
...
#| eval: false
docker run -it ghcr.io/dummy/oxa:devel bash
